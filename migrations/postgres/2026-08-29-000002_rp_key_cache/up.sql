...
CREATE TABLE rp_domain_key_cache (
    ...
    revocations_checked_at TIMESTAMPTZ NOT NULL,
...
CREATE TABLE rp_application_key_attestations (
    id UUID PRIMARY KEY,
    cache_entry_id UUID NOT NULL REFERENCES rp_application_key_cache_entries(id),
    ...
    verified_by_key_ids VARCHAR NOT NULL,
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
);
