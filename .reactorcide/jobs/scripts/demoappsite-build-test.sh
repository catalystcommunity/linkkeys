...
echo "================================================"
echo "LinkKeys Demoappsite Build Test"
echo "================================================"
...
# Build from repo root (workspace context needed for liblinkkeys dependency)
echo "Building Docker image (test only, no push)..."
docker build -t linkkeys-demoappsite-test:build -f demoappsite/Dockerfile .

echo ""
echo "================================================"
echo "Demoappsite build test passed!"
echo "================================================"
